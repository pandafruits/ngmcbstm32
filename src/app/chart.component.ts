...
export class ChartComponent implements OnInit {
  ...
  public lineChartColors: Array<any> = [
    { // grey
      backgroundColor: 'rgba(32,139,188,0.2)',
      borderColor: 'rgba(32,139,188,1)',
      pointBackgroundColor: 'rgba(32,139,188,1)',
      pointBorderColor: '#fff',
      pointHoverBackgroundColor: '#fff',
      pointHoverBorderColor: 'rgba(32,139,188,0.8)'
    },
    { // dark grey
      ...
      pointBorderColor: '#fff',
      pointHoverBackgroundColor: '#fff',
      pointHoverBorderColor: 'rgba(0,153,51,1)'
    },
    { // grey
